...
<section id="sidebar">
    ...
    <ul class="side-menu">
        ...
        <li>
            ...
            <ul class="side-dropdown">
                <li><a href="#" data-page="soumission">
        ...
        <li class="element"><a href="#" data-page="logout">
