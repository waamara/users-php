...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (editUserBtn && userFormModal) {
        editUserBtn.addEventListener("click", function () {
            ...
            const roleInput = document.getElementById("role"); // Added role input
            ...
            // Set role value
            if (roleInput) {
                roleInput.value = userData.Role || ""; // Note: using 'Role' with capital R to match database column
            }
    ...
    function validateForm() {
        ...
        const role = document.getElementById("role").value; // Added role validation
        ...
        // Validate Role
        if (!role) {
            showValidationError("role", "Veuillez sélectionner un rôle");
            isValid = false;
        }
    ...
    if (userForm) {
        userForm.addEventListener("submit", function (e) {
            ...
            const role = parseInt(document.getElementById("role").value) || 0; // Added role
            
            console.log("Form data:", { id: userId, nomComplet, userName, compte, structure, Role: role });
            ...
            fetch("../../Backend/GestionUsers/requetes_ajax/updateUser.php", {
                ...
                body: JSON.stringify({ id: userId, nomComplet, userName, compte, structure, Role: role }), // Note: using 'Role' with capital R
            })
                .then(response => {
                    ...
                    if (data.success) {
                        ...
                        if (roleEl) {
                            ...
                            if (roleSelect && roleSelect.selectedIndex >= 0) {
                                ...
                                if (selectedOption) {
                                    roleEl.textContent = selectedOption.text;
                                }
                            }
                        }
                        ...
                        window.userData.Role = role; // Update role in userData
